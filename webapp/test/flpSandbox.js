		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Traccibilita Tessuto",
									"targetURL": "#TraccibilitaTessuto-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"TraccibilitaTessuto-display": {
								"semanticObject": "TraccibilitaTessuto",
								"action": "display",
								"description": "Traccibilita Tessuto",
								"title": "Traccibilita Tessuto",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=traccibilitanmp.traccibilitatesutto",
									"url": sap.ui.require.toUrl("traccibilitanmp/traccibilitatesutto")
								}
							}
						}
					}
